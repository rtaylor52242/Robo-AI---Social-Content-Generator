...
export default function Loader() {
  return (
    <div className="flex flex-col items-center justify-center text-center my-12">
      ...
      <h3 className="text-xl font-semibold text-light-text">Generating Your Content...</h3>
      <p className="text-medium-text">The AI is crafting posts and creating images. This might take a moment.</p>
    </div>
  );
}
